public class NetworkTest {
    public static void main(String[] args) {
        ...
        System.out.println(
                "...To get started, creating a dummy network for testing the toString and getUser methods...\n");
        ...
        System.out.println(net.getUserCount());
        ...
        System.out.println("Alex: based on our social network analysis, we recommemd to follow "
                + net.recommendWhoToFollow("Alex"));

        System.out.println("***");
        System.out.println(net.recommendWhoToFollow("Alex"));
